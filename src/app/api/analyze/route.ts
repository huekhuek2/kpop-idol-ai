...
import { IDOL_LISTS } from '@/lib/constants';
...
8. Return ONLY the JSON object, no other text.`;
        ...
        if (!geminiResponse.ok) {
            ...
            return NextResponse.json({ error: 'AI analysis failed', details: errorText }, { status: geminiResponse.status });
        }
